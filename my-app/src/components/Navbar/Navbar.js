        ...
        <nav>
            <div className='s1' >
                ...
                <div className='searchbar'>
                    <input typ="text" placeholder=" البحث عن المنتجات و الفئات    " className='search' />
...
{/* الحقيبة */}
            ...
            <div className='s2'>
                ...
                <Dropdown>
                    ...
                    <Dropdown.Menu style={{textAlign:"right"}}>
                        <Dropdown.Item href="#/action-1">الملابس</Dropdown.Item>
                        <Dropdown.Item href="#/action-2">الشموع</Dropdown.Item>
                        <Dropdown.Item href="#/action-3">الفن</Dropdown.Item>
                    </Dropdown.Menu>
                </Dropdown>
                <Link to='/about'>
                    <a>عنا</a>
